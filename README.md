...
| v0.6 | `DLModelTarget`: vision transfer learning, validated on a local RTX 4050 | in progress |
...
| `DLModelTarget` | Transfer-learns a vision model, scores it | built (v0.6); the run switch lands next |
