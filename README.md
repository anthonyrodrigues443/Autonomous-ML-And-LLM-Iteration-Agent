...
| v0.6 | `DLModelTarget`: vision models for classes and numbers, validated on a local RTX 4050 | in progress |
...
| `DLModelTarget` | Trains a vision model for classes or numbers, from a plain CNN baseline to fine-tuned pretrained backbones, and scores it | built (v0.6); the run switch lands later in v0.6 |
